...
/datum/mutation/human/hulk/say_mod(message)
	if(message)
		message = "[uppertext(regEx_replacetext(message, ".", "!"))]!!"
	return message
...
/datum/mutation/human/smile/say_mod(message)
	if(message)
		...
		message = regEx_replacetext(message," stupid "," smart ")
		message = regEx_replacetext(message," retard "," genius ")
		message = regEx_replacetext(message," unrobust "," robust ")
		message = regEx_replacetext(message," dumb "," smart ")
		message = regEx_replacetext(message," awful "," great ")
		message = regEx_replacetext(message," gay ",pick(" nice "," ok "," alright "))
		message = regEx_replacetext(message," horrible "," fun ")
		message = regEx_replacetext(message," terrible "," terribly fun ")
		message = regEx_replacetext(message," terrifying "," wonderful ")
		message = regEx_replacetext(message," gross "," cool ")
		message = regEx_replacetext(message," disgusting "," amazing ")
		message = regEx_replacetext(message," loser "," winner ")
		message = regEx_replacetext(message," useless "," useful ")
		message = regEx_replacetext(message," oh god "," cheese and crackers ")
		message = regEx_replacetext(message," jesus "," gee wiz ")
		message = regEx_replacetext(message," weak "," strong ")
		message = regEx_replacetext(message," kill "," hug ")
		message = regEx_replacetext(message," murder "," tease ")
		message = regEx_replacetext(message," ugly "," beautiful ")
		message = regEx_replacetext(message," douchbag "," nice guy ")
		message = regEx_replacetext(message," whore "," lady ")
		message = regEx_replacetext(message," nerd "," smart guy ")
		message = regEx_replacetext(message," moron "," fun person ")
		message = regEx_replacetext(message," IT'S LOOSE "," EVERYTHING IS FINE ")
		message = regEx_replacetext(message," sex "," hug fight ")
		message = regEx_replacetext(message," idiot "," genius ")
		message = regEx_replacetext(message," fat "," thin ")
		message = regEx_replacetext(message," beer "," water with ice ")
		message = regEx_replacetext(message," drink "," water ")
		message = regEx_replacetext(message," feminist "," empowered woman ")
		message = regEx_replacetext(message," i hate you "," you're mean ")
		message = regEx_replacetext(message," nigger "," african american ")
		message = regEx_replacetext(message," jew "," jewish ")
		message = regEx_replacetext(message," shit "," shiz ")
		message = regEx_replacetext(message," crap "," poo ")
		message = regEx_replacetext(message," slut "," tease ")
		message = regEx_replacetext(message," ass "," butt ")
		message = regEx_replacetext(message," damn "," dang ")
		message = regEx_replacetext(message," fuck ","  ")
		message = regEx_replacetext(message," penis "," privates ")
		message = regEx_replacetext(message," cunt "," privates ")
		message = regEx_replacetext(message," dick "," jerk ")
		message = regEx_replacetext(message," vagina "," privates ")
	return trim(message)
...
/datum/mutation/human/swedish/say_mod(message)
	if(message)
		message = regEx_replacetext(message,"w","v")
		if(prob(30))
