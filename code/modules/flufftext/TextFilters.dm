...
/proc/buttificate(phrase)
	var/params = regEx_replacetext(phrase, " ", "&")
	...
	finalphrase = regEx_replacetext(finalphrase, " #39 ","'")
	finalphrase = regEx_replacetext(finalphrase, " s "," ") //this is really dumb and hacky, gets rid of trailing 's' character on the off chance that '#39' gets swapped
