...
/obj/item/clothing/mask/gas/voice/space_ninja/speechModification(message)
	if(voice == "Unknown")
		if(copytext(message, 1, 2) != "*")
			...
			message = regEx_replacetext(message, "l", "r")
			message = regEx_replacetext(message, "rr", "ru")
			message = regEx_replacetext(message, "v", "b")
			message = regEx_replacetext(message, "f", "hu")
			message = regEx_replacetext(message, "'t", "")
			message = regEx_replacetext(message, "t ", "to ")
			message = regEx_replacetext(message, " I ", " ai ")
			message = regEx_replacetext(message, "th", "z")
			message = regEx_replacetext(message, "is", "izu")
			message = regEx_replacetext(message, "ziz", "zis")
			message = regEx_replacetext(message, "se", "su")
			message = regEx_replacetext(message, "br", "bur")
			message = regEx_replacetext(message, "ry", "ri")
			message = regEx_replacetext(message, "you", "yuu")
			message = regEx_replacetext(message, "ck", "cku")
			message = regEx_replacetext(message, "eu", "uu")
			message = regEx_replacetext(message, "ow", "au")
			message = regEx_replacetext(message, "are", "aa")
			message = regEx_replacetext(message, "ay", "ayu")
			message = regEx_replacetext(message, "ea", "ii")
			message = regEx_replacetext(message, "ch", "chi")
			message = regEx_replacetext(message, "than", "sen")
			message = regEx_replacetext(message, ".", "")
